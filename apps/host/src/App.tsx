        ...
        <Suspense
          fallback={
            <div className="mfe-card mfe-spinner-wrapper">
              ...
              <span style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>Loading micro-frontend module...</span>
            </div>
          }
        >
          <Routes>
            ...
            <Route
              ...
              element={
                <div className="mfe-card" style={{ textAlign: 'center', padding: '60px 20px' }}>
                  <h2 style={{ fontSize: '24px', fontWeight: 800, marginBottom: '8px' }}>404 - Route Not Found</h2>
                  <p style={{ color: 'var(--text-secondary)', marginBottom: '16px' }}>
                    The requested micro-frontend route does not exist.
                  </p>
